...
#CLASSES = ('__background__', 'face', 'halfface', 'eye', 'mouse', 'nose', 'hair', 'bread', 'other', 'pet', 'puppet', 'sticker')
...
NETS = {'vgg16': ('VGG16', 'VGG16_faster_rcnn_final_face1000sample_1000iter.caffemodel'),
        'zf': ('ZF', 'ZF_faster_rcnn_final_voc2007_sn.caffemodel')}

#'zf': ('ZF','ZF_faster_rcnn_final.caffemodel')
#'zf': ('ZF','ZF_faster_rcnn_final_voc2007_sn100_3.caffemodel')
...
def parse_args():
    ...
    parser.add_argument('--input', dest='input_file', default='/home/chigo/working/research/faster-rcnn/py-faster-rcnn-master/data/demo/img_list.txt')
    parser.add_argument('--output', dest='output_path', default='/home/chigo/working/research/faster-rcnn/py-faster-rcnn-master/data/output_img/')
